export const dict = {
  ...
  "dialog.provider.custom.label": "OpenAI 호환 사용자 지정 제공업체",
  ...
  "dialog.model.unpaid.viewMoreProviders": "70개 이상의 제공업체 더 보기",
  ...
  "provider.connect.method.hint.browser": "브라우저",
  "provider.connect.method.hint.headless": "헤드리스",
